...
type GetUsersReq struct {
	...
	UserIds map[string]int32 `protobuf:"bytes,1,rep,name=user_ids,json=userIds,proto3" json:"user_ids,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 用户业务id
}
...
func (x *GetUsersReq) GetUserIds() map[string]int32 {
	if x != nil {
		return x.UserIds
	}
	return nil
...
type GetUsersResp struct {
	...
	Users map[string]*User `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 用户信息
}
...
func (x *GetUsersResp) GetUsers() map[string]*User {
	if x != nil {
		return x.Users
	}
	return nil
