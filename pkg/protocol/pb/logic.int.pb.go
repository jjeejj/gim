...
type ConnSignInReq struct {
	...
	UserId     string `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`             // 用户业务id
...
func (x *ConnSignInReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *SyncReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *MessageACKReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *SubscribeRoomReq) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
