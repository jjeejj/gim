...
func (x *SignInInput) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
func (x *HeartbeatInput) GetDeviceId() int64 {
	if x != nil {
		return x.DeviceId
	}
	return 0
...
func (x *HeartbeatInput) GetUserId() string {
	if x != nil {
		return x.UserId
	}
	return ""
...
var file_connect_ext_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x73, 0x65, 0x71, 0x22, 0x67, 0x0a, 0x0a, 0x4d, 0x65, 0x73,
	...
	0x63, 0x65, 0x69, 0x76, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x75, 0x73, 0x65,
	0x72, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x22, 0x46, 0x0a, 0x0e, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x49,
	...
	0x28, 0x09, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x2a, 0x73, 0x0a, 0x0b, 0x50, 0x61,
...
var file_connect_ext_proto_goTypes = []interface{}{
	...
	(*HeartbeatInput)(nil),     // 8: pb.HeartbeatInput
...
var file_connect_ext_proto_depIdxs = []int32{
	...
	9, // 2: pb.SyncOutput.messages:type_name -> pb.Message
