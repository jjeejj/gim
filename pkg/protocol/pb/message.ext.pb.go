...
type Message struct {
	...
	UserSeq  string        `protobuf:"bytes,3,opt,name=user_seq,json=userSeq,proto3" json:"user_seq,omitempty"`       // 用户消息发送序列号, 收到信息的 user_id_seq
	Seq      int64         `protobuf:"varint,4,opt,name=seq,proto3" json:"seq,omitempty"`                             // 用户消息发送序列号
	SendTime int64         `protobuf:"varint,5,opt,name=send_time,json=sendTime,proto3" json:"send_time,omitempty"`   // 消息发送时间戳，精确到毫秒
	Status   MessageStatus `protobuf:"varint,6,opt,name=status,proto3,enum=pb.MessageStatus" json:"status,omitempty"` // 消息状态
}
...
func (x *Message) GetUserSeq() string {
	if x != nil {
		return x.UserSeq
	}
	return ""
...
var file_message_ext_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0xac, 0x01, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73,
	...
	0x74, 0x12, 0x19, 0x0a, 0x08, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x73, 0x65, 0x71, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x73, 0x65, 0x72, 0x53, 0x65, 0x71, 0x12, 0x10, 0x0a, 0x03,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x70, 0x62,
	0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52, 0x06,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2a, 0x2d, 0x0a, 0x0d, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
