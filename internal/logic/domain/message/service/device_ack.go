...
// Update 更新ack
func (*deviceAckService) Update(ctx context.Context, userId string, deviceId, ack int64) error {
	if ack <= 0 {
		return nil
	}
...
func (*deviceAckService) GetMaxByUserId(ctx context.Context, userId string) (int64, error) {
